...
import com.praveen.pilani.workout.persist.FitApiFailureResolutionService;
...
public abstract class BaseActivity extends DialogActivity implements FitApiFailureResolutionService.FitApiFailureResolver {
    public static final String EXTRA_PLAY_API_CONNECT_RESULT = "com.praveen.pilani.workout.play_api_connect_result";
    private static final String TAG = BaseActivity.class.getSimpleName();
    private static final int REQUEST_FAILURE_RESOLUTION = 0;
    private static final String KEY_FAILURE_RESOLUTION_IN_PROGRESS = "com.praveen.pilani.workout.failure_resolution_in_progress";
    private static final String TAG_ERROR_DIALOG = "error_dialog";
    private static final String ARG_ERROR_CODE = "com.praveen.pilani.workout.play_api_error_code";
