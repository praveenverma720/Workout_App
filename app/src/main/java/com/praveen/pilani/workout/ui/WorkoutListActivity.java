...
import com.praveen.pilani.workout.util.ui.BackgroundTintListAnimator;
import com.praveen.pilani.workout.util.ui.DividerItemDecoration;
import com.praveen.pilani.workout.util.ui.EmptyRecyclerView;
import com.praveen.pilani.workout.util.ui.MasterDetailLayout;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_privacy:
                startActivity(new Intent(Intent.ACTION_VIEW, parse("https://comedymama.com")));
                return true;
            default:
